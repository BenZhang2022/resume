...
以 CRM 和销售数字化为长期主轴，历任 Business Analyst、Business Design Consultant、Project Manager、Sales Enablement 等角色，参与三代 CRM 平台演进。2022 年后作为 APAC 团队成员，在以英文为主的跨区域、跨时区环境中，与区域业务、IT 平台团队及各市场用户协作，支持约 10,000 名相关用户，具备海外团队沟通与多方协调能力；同时具备从需求调研、流程设计、路线图和 PoC，到 UAT、上线、培训、运营及反馈迭代的端到端交付能力。
...
- 亚太区协作与变革管理：作为 APAC 团队成员，在英文及跨时区环境中连接区域业务、IT 平台和各市场用户，推动沟通、培训、推广与用户采用。
...
- 项目期间快速熟悉联想跨部门协作机制，协同 SMB 业务、战略及 IT 团队（包括数据与模型团队），围绕业务规则、数据口径和产品方案推动评审决策，完成阶段成果交付及项目资料交接。
- 建立智能价格审批 AB Test 复盘框架，分析百余个立项、产品明细及转订单数据；识别多数样本的 AI 推荐价与最终审批价位于合理偏差区间，并定位低价放行、产品差异、毛利口径和多策略报价区分度等问题。
- 基于数据复盘拆解审批规则与角色差异，形成“模型推荐 + 定价业务规则 + 流程提效 + AI 辅助审批”路线图；设计角色化审批通知与决策工作台 PoC，并将渠道商机经验沉淀为五类可解释规则及三类交付路径。
...
- 2022 年后作为 APAC 团队成员，在以英文为主的跨市场、跨时区工作环境中，与区域业务负责人、IT 平台团队及各市场用户协作，支持约 10,000 名相关用户的 CRM / Sales Enablement 场景。
...
- 协作：快速熟悉联想跨部门协作机制，连接 SMB 业务、战略及 IT 团队（包括数据与模型团队），推动业务规则、数据口径和产品方案对齐。
- 成果：建立 AB Test 复盘框架，通过百余个真实立项及产品明细识别 AI 推荐价的有效区间，并定位低价放行、产品差异和财务口径不一致等优化重点。
- 方案：形成价格审批优化路线图、角色化通知及决策工作台 PoC，并将渠道商机经验沉淀为可解释规则和三类交付路径，完成阶段成果与资料交接。
