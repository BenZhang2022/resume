...
曾以外部顾问身份担任联想中国区 SMB DT 项目产品经理，参与智能价格审批与渠道交付等企业 AI 场景，熟悉与业务、战略及 IT 团队的跨部门协作方式；同时具备 Watson Assistant、知识库问答、票据抽取与流程自动化实践。拥有计算机教育和应用开发基础，能够与架构、开发、数据和供应商团队协作，从业务价值、数据质量和治理边界评估方案，并通过自动化与轻量原型加速验证。
...
- 项目期间快速熟悉联想跨部门协作机制，协同 SMB 业务、战略及 IT 团队（包括数据与模型团队），围绕业务规则、数据口径和产品方案开展评审与沟通，完成阶段成果整理及项目资料交接。
...
- 协作：快速熟悉联想跨部门协作机制，与 SMB 业务、战略及 IT 团队（包括数据与模型团队）围绕业务规则、数据口径和产品方案开展评审与沟通。
